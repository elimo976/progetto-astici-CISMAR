<template>
  ...
  <section class="bg-custom-beige text-gray-800 md:px-8 px-12 py-8 text-left text-lg w-full">
    <div class="max-w-7xl mx-auto">
      ...
      <div class="max-w-[44rem] mx-auto my-10">
        <p>{{ $t('geneticsText1') }}</p>
        <br />
        <p>{{ $t('geneticsText2') }}</p>
        <br />
...
export default defineComponent({
  ...
  setup() {
    ...
    onMounted(() => {
      ...
      const metaTags = [
        { name: 'description', content: t('pageDescriptionGenetics') },
        { property: 'og:title', content: t('ogTitleGenetics') },
        { property: 'og:description', content: t('ogDescriptionGenetics') },
        { name: 'keywords', content: t('keywordsGenetics') },
